...
<body div class="p-3 mb-2 bg-dark text-white"></div>
	...
	<h2 class="text-primary">Bus owner Registration</h2><br>
	...
	<form action="inBusOwner" method="post">
        ...
        <div class="col-sm-10">
        <input type="text" name="NIC" class="form-control" pattern="[0-9]+" pattern="[0-9]+"><br><br>
        </div>
        ...
        <div class="col-sm-10">
        <input type="email" name="email" class="form-control" pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$"><br><br>
        </div>


        <label for="inputEmail3" class="col-sm-2 col-form-label">User name</label>
        <div class="col-sm-10">
        <input type="text" name="username" class="form-control" pattern="[A-Za-z0-9]+"><br><br>
        </div>
